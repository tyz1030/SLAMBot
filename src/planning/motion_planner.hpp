...
struct MotionPlannerParams
{
    ...
    */
    ...
    : robotRadius(0.16) // by default, have a little extra slop to keep the robot from getting too close to the walls
    {
    }
};
...
public:
    ...
    */
    const ObstacleDistanceGrid& obstacleDistances(void) const { return distances_; }

...
# sensor model
CFLAGS_SENSOR  := -I$(SRC_PATH) $(CFLAGS_STD)
LDFLAGS_SENSOR := -L$(LIB_PATH) -lsensor $(LDFLAGS_STD)

# action model
CFLAGS_ACTION  := -I$(SRC_PATH) $(CFLAGS_STD)
LDFLAGS_ACTION := -L$(LIB_PATH) -laction $(LDFLAGS_STD)
